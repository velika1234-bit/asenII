      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        <div className="bg-stone-900/60 border border-amber-800/30 rounded-xl p-4 sm:p-6 mb-5 sm:mb-7 text-left space-y-3">
          ...
          <p className="text-stone-300 leading-relaxed text-xs sm:text-sm">
            Всеки твой избор ще повлияе на трите показателя на царството. Мъдрият владетел балансира военната сила, дипломатическите отношения и благоденствието на народа. Историческите летописи ще се разкриват <em>след</em> всяко решение.
          </p>
